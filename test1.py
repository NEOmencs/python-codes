...
print("__________________________________1_________________________________________________________")
...
print("____________________________________2_______________________________________________________")
print("___________________________________________________________________________________________")
...
print("___________________________________3________________________________________________________")
print("___________________________________________________________________________________________")
...
df_movie_new.index = df_movie_new['complete_path'].str.len()
df_movie_new = df_movie_new.sort_index(ascending=False).reset_index(drop=True)

print("__________________________________4_________________________________________________________")
print("___________________________________________________________________________________________")

for x in range(len(df_movie_new)):
    df_movie_new.loc[x]['to_rename'] = df_movie_new.loc[x]['to_rename'].replace(":","")
    os.rename(df_movie_new.loc[x]['complete_path'].rsplit("\\",1)[0],os.path.join(df_movie_new.loc[x]['complete_path'].rsplit("\\",2)[0],df_movie_new.loc[x]['to_rename']))
